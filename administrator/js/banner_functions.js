	...
	//上传图片前显示默认空白占位图片
		...
		{
			document.getElementById("showimg").innerHTML ="<img src='./images/banner_blank.gif'>";
		}
	
	
	//Function to determine when the process_upload.php file has finished executing.
	function doneloading(theframe,thefile){
		var theloc = "banner_showimg.php?thefile=" + thefile
	...
	function setStatus (theObj){
		...
		if (obj){
			...
			obj.innerHTML = "<img src='./images/banner_loading.gif' style='margin:8px 0 0 30px'>";
		}
	}
